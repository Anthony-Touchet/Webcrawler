    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            while (active == true)
            {
                ...
                var site = "https://anthony-touchet.github.io";                  // Site name
        ...
        public static void FindSkills(string line, StreamReader sr)
        {
        ...
        public static void FindLinks(string line, StreamReader sr, string siteName)
        {
